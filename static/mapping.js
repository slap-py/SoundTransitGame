...
function createStop_visual(title,coordinates,routes){
    marker1 = L.marker (coordinates,{icon:stopIcon})
    marker1.bindPopup(`<strong>${title}</strong><br>Routes: ${routes.join(', ')}`)
...
createStop_visual('3rd & Seneca', [47.606931816681566, -122.3351124129687],['14','230'])
createStop_visual('1st & Stewart', [47.610444151300676, -122.34140160419284],['17','38'])
createStop_visual('1st & Union', [47.60770607349066, -122.33912025605323],['17','230'])

createStop_visual('Pine & Alaskan', [47.60872352035995, -122.3437810113533],['4','B'])
createStop_visual('23rd & Yesler', [47.60178113259038, -122.30370247299345],['53','29','630'])
createStop_visual('Weller & Rainier', [47.5976186696487, -122.31271099433737],['17'])

createStop_visual('Westlake & Mercer', [47.62448035843266, -122.33807076006781],['49'])
